...
| **TWA 출시 작업 진행/완료** (유저 "할 일" 발화 포함) | `docs/twa-출시-할일.md` | 해당 항목 ☐ → ✅ + §0 진행 상태 갱신. 결정 근거·리스크는 `docs/PRD.md` §10에 있으니 중복 기재 금지 |
...
| 수익 모델 · 플랫폼(TWA/네이티브) 결정 변경 | `docs/PRD.md` §9 / §10 | §10-5 "뒤집어야 하는 조건" 해당 시 결정 전체 재검토. 결론만 승계 금지 |
