...
> - `docs/PRD.md` §9~§10 (수익 모델·플랫폼 전략) — 수익화·스토어·플랫폼 관련 작업 시. §10-5의 "뒤집어야 하는 조건" 해당 여부를 먼저 확인한다.

> **"할 일" 발화 시 자동 참조 대상**
> - `docs/phase3-할일.md` — 로그인·동기화·결제·푸시 (로그인·동기화는 완료)
> - `docs/하이브리드-출시-할일.md` — iOS·Android 스토어 출시 (Capacitor). TWA 방식은 2026-07-23 폐기됨
