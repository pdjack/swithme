    ...
    },
    {
        ...
        body: `
            ...
            <ol class="tut-steps">
                ...
                <li><b>종합 점수 카드</b> — 회고 점수를 평균낸 100점 만점. 아래에 항목별 평균(시간관리·복습 등)이 함께 표시. 이전 스냅샷과 비교한 <b>증감 표시(▲▼)</b>도 떠요.</li>
                <li><b>카테고리별 활동 시간 그래프</b> — 어디(영어·운동·일 등)에 얼마나 시간을 썼는지 막대 그래프로 비교. 색은 카테고리 색 그대로.</li>
                <li><b>인사이트 카드</b> ✨ — 데이터를 자동 분석해 "수학 시간이 평소보다 30% 늘었어요" 같은 발견을 알려줘요.</li>
                <li><b>처방전 카드</b> ⚡ — 약점을 콕 집어 개선 액션을 제안. 예: "회고를 자주 빠뜨려요. 매일 저녁 알람 추천."</li>
                <li><b>회고 메모 모음</b> 📓 — 그 기간 동안 남긴 메모들을 한 화면에서 다시 읽을 수 있어요.</li>
            </ol>
            <p class="tut-tip">💡 <b>스냅샷 저장</b> — 위쪽 '저장' 버튼을 누르면 지금 분석 결과가 통째로 보관돼요. 한 달 뒤·시험 후 다시 비교해 발전을 확인할 수 있어요. 저장 시 이름·메모도 함께 남길 수 있고, '저장됨' 폴더에서 언제든 열어볼 수 있어요.</p>
        `,
    ...
    analyze: {
        ...
        body: `
            ...
            <ol class="tut-steps">
                ...
                <li><b>인사이트 ✨</b> — "수학 시간이 30% 늘었어요" 같은 자동 발견.</li>
                <li><b>처방전 ⚡</b> — 약점 보완 액션 제안.</li>
                <li><b>회고 메모 모음 📓</b> — 그 기간 메모 다시 읽기.</li>
            </ol>
            <p class="tut-tip">💡 <b>스냅샷 저장</b>으로 지금 상태 보관 → 나중에 변화 비교. '저장됨' 폴더에서 언제든 열람.</p>
        `,
        mobile: '#m-analyze-panel',
        desktop: '#analyze-canvas',
    },
